/**
 * $Id: LogRuntimeException.java,v 1.5 2016/12/10 20:55:18 oboehm Exp $
 *
...
/**
 * You want to see a RuntimeException in the log if it happens? Use this
...
public @interface LogRuntimeException {
