 ...
 * @since 19.02.2009
 */
public final class OnlyForTesting5Test {

    private static final Log log = LogFactory.getLog(OnlyForTesting5Test.class);
    ...
    public void testAllowedUse() {
        ...
        new OnlyForTesting5Test("hello world");
    }
     ...
     */
    @OnlyForTesting
    protected OnlyForTesting5Test(final String hello) {
        log.info(hello);
    }
